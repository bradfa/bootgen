...
#line 94 "cmdoptions.tab.hpp"
   ...
   enum yytokentype {
     ...
     H_BIF_AARCH32 = 436,
     H_BIF_BIGENDIAN = 437,
     H_BIF_BOOTCONFIG = 438,
     H_BIF_COPY = 439,
     H_BIF_CORE = 440,
     H_BIF_DELAY_HANDOFF = 441,
     H_BIF_DELAY_LOAD = 442,
     H_BIF_FILE = 443,
     H_BIF_ID = 444,
     H_BIF_IMAGE = 445,
     H_BIF_METAHDR = 446,
     ...
     H_BIF_SLR = 449,
     H_BIF_TYPE = 450,
     H_BIF_KEYSRCENCR = 451,
     H_BIF_PARENTID = 452,
     H_DPACM_ENABLE = 453,
     H_BIF_USERKEYS = 454,
     HVN_BIF_PCR = 455,
     HVN_BIF_PCR_MINDEX = 456,
     HV_BIF_IMAGESTORE = 457
   };
